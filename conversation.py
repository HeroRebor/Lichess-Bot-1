...
class Conversation:
    ...
    def command(self, line, game, cmd):
        if cmd == "commands" or cmd == "help":
            ...
            self.send_reply(line, "About: I am bot made by @Soloboy4! Challenge me anytime , if you have problem Regards me ask @Soloboy4.My Version2 bot still on Construction , when it will be made you can Challenge version2 bot too")
